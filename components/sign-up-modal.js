              ...
              <div className="mb-12">
                <div className="flex justify-center mb-4">
                  <svg className="w-24 h-24" viewBox="0 0 100 100" fill="none">
                    {/* Graduation Cap */}
                    <rect x="30" y="20" width="40" height="8" fill="#001a4d" rx="1" />
                    <polygon points="50,28 65,35 35,35" fill="#001a4d" />
                    <rect x="48" y="28" width="4" height="15" fill="#001a4d" />

                    {/* Phone */}
                    <rect x="35" y="45" width="30" height="45" fill="none" stroke="#001a4d" strokeWidth="2" rx="3" />
                    <rect x="37" y="47" width="26" height="35" fill="#FF6B35" rx="2" />
                    <line x1="50" y1="85" x2="50" y2="87" stroke="#001a4d" strokeWidth="1.5" />
                  </svg>
                </div>
