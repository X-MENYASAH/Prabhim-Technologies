...
export function CoursesHeroSection() {
  return (
    <section className="relative w-[1290px] h-[324px] mx-auto overflow-hidden rounded-3xl border-2 border-orange-200/50 hover:border-orange-300/70 transition-all duration-500">
      {/* Gradient Background */}
