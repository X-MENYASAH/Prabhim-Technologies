    ...
    <div className="relative">
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          <Link
            href="/blogs"
            className="block text-gray-600 font-medium py-3 px-4 rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-all duration-200 transform hover:scale-105 active:scale-95 touch-manipulation"
            onClick={() => setIsOpen(false)}
          >
            BLOGS
          </Link>
